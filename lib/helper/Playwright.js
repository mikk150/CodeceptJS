...
const availableBrowsers = ['chromium', 'webkit', 'firefox', 'electron', 'android'];
...
class Playwright extends Helper {
  ...
  _setConfig(config) {
    ...
    this.isAndroid = this.options.browser === 'android';
  ...
  static _config() {
    return [
      ...
      {
        name: 'browser',
        message: 'Browser in which testing will be performed. Possible options: chromium, firefox, webkit, electron or android',
        default: 'chromium',
      },
    ];
  }
  ...
  */
  ...
  async _startBrowser() {
    if (this.isElectron) {
      ...
      this.browser = await this.#device.launchBrowser(this.playwrightOptions);
    } else {
